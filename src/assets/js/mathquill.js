...
LatexCmds['\u221a'] = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\sqrt';
  _.htmlTemplate =
      '<span class="mq-non-leaf" id="test1">'
...
LatexCmds.nthroot = P(SquareRoot, function(_, super_) {
  _.htmlTemplate =
      '<sup class="mq-nthroot mq-non-leaf" id="test2">&0</sup>'
    + '<span class="mq-scaled">'
    +   '<span class="mq-sqrt-prefix mq-scaled">&radic;</span>'
    +   '<span class="mq-sqrt-stem mq-non-leaf" id="test3">&1</span>'
    + '</span>'
  ;
  _.textTemplate = ['sqrt[', '](', ')'];
  _.latex = function() {
...
/*added by Shobhit*/
var ChemistryFraction =
LatexCmds.LongRightwardsArrow =
LatexCmds.chemfraction = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\LongRightwardsArrow';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf">'
    +   '<span class="mq-numerator" style="margin-bottom: -12px; font-size:small;">&0</span>'
    +   '<span  style="display: inline-block; font-weight: bold; line-height: 0; vertical-align: middle; margin-bottom: -15px; margin-top: 0px;">&#10230;</span><br />'
...
var CustomMade1 =
LatexCmds.LongLeftwardsArrow =
LatexCmds.Custom1 = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\LongLeftwardsArrow';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf">'
    +   '<span class="mq-numerator" style="margin-bottom: -12px;font-size:small;">&0</span>'
    +   '<span  style="display: inline-block; font-weight: bold;line-height: 0; vertical-align: middle; margin-bottom: -15px; margin-top: 0px;">&#10229;</span><br />'
...
var CustomMade =
LatexCmds.LongRightwardsArrowNum =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\LongRightwardsArrowNum';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf">'
    +   '<span class="mq-numerator" style="margin-bottom: -12px;font-size:small;">&0</span>'
    +   '<span  style="display: inline-block;font-weight: bold; line-height: 0; vertical-align: middle; margin-bottom: -15px; margin-top: 0px;">&#10230;</span><br />'
...
var CustomMade =
LatexCmds.LongLeftwardsArrowNum =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\LongLeftwardsArrowNum';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf">'
    +   '<span class="mq-numerator" style="margin-bottom: -12px; margin-top:-10px; font-size:small;">&0</span>'
    +   '<span  style="display: inline-block; font-weight: bold; line-height: 0; vertical-align: middle; margin-bottom: -15px; margin-top: 0px;">&#10229;</span><br />'
      +   '<span style="font-size:small;"></span>'
...
var CustomMade =
LatexCmds.LongRightwardsArrowDino =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\LongRightwardsArrowDino';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf">'
      +   '<span style="font-size:small;"></span>'
     
     +   '<span  style="display: inline-block; font-weight: bold; line-height: 0; vertical-align: middle; margin-bottom: -15px; margin-top: 0px;">&#10230;</span><br />'
    +   '<span class="mq-numerator" style="margin-bottom: 0px; font-size:small;">&0</span>'
...
var CustomMade =
LatexCmds.LongLeftwardsArrowDino =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\LongLeftwardsArrowDino';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf">'
      +   '<span style="font-size:small;"></span>'
...
var CustomMade =
LatexCmds.RightwardsArrowDino =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\RightwardsArrowDino';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf">'
   
    +   '<span  style="display: inline-block; line-height: 0; vertical-align: middle; margin-bottom: -15px; margin-top: 0px;">&#10230;</span><br />'
    +   '<span class="">&0</span>'
    +   '<span style="display:inline-block;width:0">&#8203;</span>'
    + '</span>'
  ;
...
var CustomMade =
LatexCmds.LeftRightArrowDino =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\LeftRightArrowDino';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf">'
...
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  ...
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf">'
    +   '<span class="mq-numerator" style="margin-bottom: -15px;">&0</span>'
    +   '<span  style="display: inline-block; line-height: 0; vertical-align: middle; margin-bottom: -15px; margin-top: 0px;">&#8213;</span><br />'
...
var CustomMade =
LatexCmds.TopCurlyBracket =
LatexCmds.custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\TopCurlyBracket';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf">'
   
    +   '<span  style="display: inline-block; line-height: 0; vertical-align: middle; margin-bottom: 0px; margin-top: 0px;">&#9182;</span><br />'
    +   '<span style="display:inline-block;width:0">&#8203;</span>'
    +   '<span class="">&0</span>'
...
var CustomMade =
LatexCmds.TopParenthasis =
LatexCmds.custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\TopParenthasis';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf">'
...
var CustomMade =
LatexCmds.BottomParenthasis =
LatexCmds.custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\BottomParenthasis';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf">'
    +   '<span class="mq-numerator" style="margin-bottom: -15px;">&0</span>'
    +   '<span  style="display: inline-block; line-height: 0; vertical-align: middle; margin-bottom: 0px; margin-top: 15px;">&#9181;</span><br />'
    +   '<span style="display:inline-block;width:0">&#8203;</span>'
    +   '<span class=""></span>'
...
var CustomMade =
LatexCmds.BottomCurlyBracket =
LatexCmds.custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\BottomCurlyBracket';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf">'
    +   '<span class="mq-numerator" style="margin-bottom: 0px;">&0</span>'
    +   '<span  style="display: inline-block; line-height: 0; vertical-align: middle; margin-bottom: 0px; margin-top: -15px;">&#9183;</span><br />'
...
LatexCmds.custom = P(MathCommand, function(_, super_) {
  ...
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf">'
    +   '<span class="mq-numerator" style="margin-bottom: 0px;"></span>'
    +   '<span  style="display: inline-block; line-height: 0; vertical-align: middle; margin-bottom: -18px; margin-top: 0px;">&circ;</span><br />'
    +   '<span style="display:inline-block;width:0">&#8203;</span>'
    +   '<span class="">&0</span>'
...
var CustomMade =
LatexCmds.TildeAccent =
LatexCmds.custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\TildeAccent';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf">'
    +   '<span class="mq-numerator" style="margin-bottom: 0px;"></span>'
    +   '<span  style="display: inline-block; line-height: 0; vertical-align: middle; margin-bottom: -18px; margin-top: 0px;">&#8764;</span><br />'
    +   '<span style="display:inline-block;width:0">&#8203;</span>'
    +   '<span class="">&0</span>'
...
LatexCmds.custom = P(MathCommand, function(_, super_) {
  ...
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf">'
    +   '<span class="mq-numerator" style="margin-bottom: 0px;"></span>'
    +   '<span  style="display: inline-block; line-height: 0; vertical-align: middle; margin-bottom: -28px; margin-top: 0px;">&#168;</span><br />'
    +   '<span style="display:inline-block;width:0">&#8203;</span>'
    +   '<span class="">&0</span>'
...
var CustomMade =
LatexCmds.EncloseLeft =
LatexCmds.custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\EncloseLeft';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf">'
    +   '<span class="mq-numerator" style="margin-bottom: 0px;"></span>'
    +   '<span  style="display: inline-block; line-height: 0; vertical-align: middle; margin-right: -6px; margin-top: 7px;">&#65372;</span>'
    +   '<span style="display:inline-block;width:0">&#8203;</span>'
    +   '<span class="">&0</span>'
...
var CustomMade =
LatexCmds.EncloseRight =
LatexCmds.custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\EncloseRight';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf">'
    +   '<span class="mq-numerator" style="display: inline-block; margin-bottom: 0px;">&0</span>'
    +   '<span  style="display: inline-block; line-height: 0; vertical-align: middle; margin-left: -5px; margin-top: 6px;">&#65372;</span>'
    +   '<span style="display:inline-block;width:0">&#8203;</span>'
    +   '<span class=""></span>'
...
var CustomMade =
LatexCmds.DoubleBarEnclosed =
LatexCmds.custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\DoubleBarEnclosed';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf">'
    +   '<span  style="display: inline-block; line-height: 0; vertical-align: middle; margin-right: 0px; margin-top: 4px;">&#8214;</span>'
    +   '<span class="mq-numerator" style="display: inline-block; margin-bottom: 0px;">&0</span>'
    +   '<span  style="display: inline-block; line-height: 0; vertical-align: middle; margin-left: 0px; margin-top: 4px;">&#8214;</span>'
    +   '<span style="display:inline-block;width:0">&#8203;</span>'
    +   '<span class=""></span>'
...
var CustomMade =
LatexCmds.AngleBracketEnclosed =
LatexCmds.custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\AngleBracketEnclosed';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf" >'
    +   '<span  style="display: inline-block; line-height: 0; vertical-align: middle; margin-right: 0px; margin-top: 4px;">&#12296;</span>'
    +   '<span class="mq-numerator" style="display: inline-block; margin-bottom: 0px;">&0</span>'
...
var CustomMade =
LatexCmds.EncloseCircle =
LatexCmds.custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\EncloseCircle';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf circle">'
    +   '<span class="mq-numerator" style="display: inline-block; margin-bottom: 0px;">&0</span>'
    +   '<span  style="display: inline-block; line-height: 0; vertical-align: middle; margin-left: 3px; margin-top: 0px;"></span>'
    +   '<span style="display:inline-block;width:0">&#8203;</span>'
    +   '<span class=""></span>'
...
var CustomMade =
LatexCmds.EncloseBox =
LatexCmds.custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\EncloseBox';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf">'
    +   '<div class="mq-numerator" style="border:1px solid black; text-align:center; padding:6px; display: inline-block;">&0</div>'
 +   '<span  style="display: inline-block; line-height: 0; vertical-align: middle; margin-left: 3px; margin-top: 0px;"></span>'
    +   '<span style="display:inline-block;width:0">&#8203;</span>'
    +   '<span class=""></span>'
...
var CustomMade =
LatexCmds.UpDiagonalStrike =
LatexCmds.custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\UpDiagonalStrike';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf ">'
    +   '<span class="mq-numerator" style="display: inline-block; margin-bottom: 0px;">&0</span>'
    +   '<span  style="display: inline-block; line-height: 0; vertical-align: middle; margin-left: -8px; margin-top: 0px;">&#47;</span>'
    +   '<span style="display:inline-block;width:0">&#8203;</span>'
    +   '<span class=""></span>'
...
var CustomMade =
LatexCmds.DownDiagonalStrike =
LatexCmds.custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\DownDiagonalStrike';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf ">'
    +   '<span class="mq-numerator" style="display: inline-block; margin-bottom: 0px;">&0</span>'
    +   '<span  style="display: inline-block; line-height: 0; vertical-align: middle; margin-left: -8px; margin-top: 0px;">&#92;</span>'
...
LatexCmds.custom = P(MathCommand, function(_, super_) {
  ...
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf ">'
    +   '<span class="mq-numerator" style="display: inline-block; margin-bottom: 0px;">&0</span>'
    +   '<span  style="display: inline-block; line-height: 0; vertical-align: middle; margin-left: -12px; margin-top: 0px;">&#8213;</span>'
    +   '<span style="display:inline-block;width:0">&#8203;</span>'
    +   '<span class=""></span>'
...
var CustomMade =
LatexCmds.CrossStrike =
LatexCmds.custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\CrossStrike';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf ">'
    +   '<span class="mq-numerator" style="display: inline-block; margin-bottom: 0px;">&0</span>'
    +   '<span  style="display: inline-block; line-height: 0; vertical-align: middle; margin-left: -11px; margin-top: 4px;">&#5815;</span>'
    +   '<span style="display:inline-block;width:0">&#8203;</span>'
    +   '<span class=""></span>'
...
var CustomMade =
LatexCmds.BevelledFraction =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\BevelledFraction';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf">'
    +   '<span class="mq-numerator" style="display: inline-block; margin-bottom: 15px;">&0</span>'
    +   '<span  style="display: inline-block; line-height: 0; vertical-align: middle; margin-bottom: 0px; margin-top: 0px;">&#47;</span>'
    +   '<span class="" style="margin-top: 15px;">&1</span>'
    +   '<span style="display:inline-block;width:0">&#8203;</span>'
    + '</span>'
  ;
  _.textTemplate = ['(', ')/(', ')'];
...
var CustomMade =
LatexCmds.TopDownScript =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\TopDownScript';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf">'
    +   '<span class="mq-numerator" style="font-size:x-small; margin-bottom: 0px;">&0</span>'
    +   '<span class="mq-numerator" style=" margin-bottom: 0px;">&1</span>'
   +   '<span class="mq-numerator" style=" font-size:x-small; margin-bottom: 0px;">&2</span>'
    +   '<span style="display:inline-block;width:0">&#8203;</span>'
    + '</span>'
  ;
  _.textTemplate = ['(', ')/(', ')/(', ')'];
...
var CustomMade =
LatexCmds.DownScript =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\DownScript';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf">'
    +   '<span class="mq-numerator" style=" margin-bottom: 0px;">&0</span>'
    +   '<span class="mq-numerator" style=" font-size:x-small; margin-bottom: 0px;">&1</span>'
    + '</span>'
  ;
  _.textTemplate = ['(', ')/(', ')'];
  _.finalizeTree = function() {
...
var CustomMade =
LatexCmds.DownBracketScript =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\DownBracketScript';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf">'
    +   '<span class="mq-numerator" style=" margin-bottom: 0px;">&0</span>'
    +   '<span  style="display: inline-block; line-height: 0; vertical-align: middle; margin-bottom: 0px; margin-top: -20px;">&#9182;</span><br />'
    +   '<span class="mq-numerator" style=" font-size:x-small; margin-top: -12px;">&1</span>'
    + '</span>'
  ;
  _.textTemplate = ['(', ')/(', ')'];
  _.finalizeTree = function() {
...
var CustomMade =
LatexCmds.UpBracketScript =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\UpBracketScript';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf">'
    +   '<span class="mq-numerator" style=" margin-bottom: 0px;">&0</span>'
    +   '<span  style="display: inline-block; line-height: 0; vertical-align: middle; margin-bottom: 0px; margin-top: -20px;">&#9183;</span><br />'
...
var CustomMade =
LatexCmds.BigTopDownScript =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\BigTopDownScript';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf">'
    +   '<span class="mq-numerator" style="font-size:small; margin-bottom: 0px;">&0</span>'
    +   '<span class="mq-numerator" style="font-size:x-large; margin-bottom: 0px;">&1</span>'
   +   '<span class="mq-numerator" style=" font-size:small; margin-bottom: 0px;">&2</span>'
    +   '<span style="display:inline-block;width:0">&#8203;</span>'
    + '</span>'
  ;
  _.textTemplate = ['(', ')/(', ')/(', ')'];
...
var CustomMade =
LatexCmds.BigDownScript =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\BigDownScript';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf">'
    +   '<span class="mq-numerator" style=" font-size:x-large; margin-bottom: 0px;">&0</span>'
    +   '<span class="mq-numerator" style=" font-size:small; margin-bottom: 0px;">&1</span>'
    + '</span>'
  ;
  _.textTemplate = ['(', ')/(', ')'];
  _.finalizeTree = function() {
...
var CustomMade =
LatexCmds.BigDownSubScript =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\BigDownSubScript';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf">'
    +   '<span class="mq-numerator" style="text-align: left; font-size:x-large; margin-bottom: 0px;">&0</span>'
    +   '<span class="mq-numerator" style="text-align: left; font-size:small; margin-top: -7px; margin-left: 16px">&1</span>'
    + '</span>'
  ;
  _.textTemplate = ['(', ')/(', ')'];
  _.finalizeTree = function() {
...
var CustomMade =
LatexCmds.BigTopDownSubScript =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\BigTopDownSubScript';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf style="margin-top:-20px;">'
    +   '<span class="mq-numerator" style="text-align: left; font-size:small; margin-left: 15px; margin-bottom: -5px;">&0</span>'
    +   '<span class="mq-numerator" style="text-align: left; font-size:x-large; margin-bottom: 0px;">&1</span>'
   +   '<span class="mq-numerator" style=" text-align: left; font-size:small; margin-left: 15px; margin-top: -5px;">&2</span>'
    +   '<span style="display:inline-block;width:0">&#8203;</span>'
    + '</span>'
  ;
  _.textTemplate = ['(', ')/(', ')/(', ')'];
...
var CustomMade =
LatexCmds.sigmaUnder =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\sigmaUnder';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf">'
    +   '<span class="mq-numerator" style="text-align: left; font-size:x-large; margin-bottom: 0px;">&#8721</span>'
    +   '<span class="mq-numerator" style=" text-align: left; font-size:small; margin-left: 5px; margin-top: -5px;">&0</span>'
    + '</span>'
  ;
  _.textTemplate = ['(', ')'];
  _.finalizeTree = function() {
...
var CustomMade =
LatexCmds.sigmaUnderOver =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\sigmaUnderOver';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf" style="margin-top:-8px">'
    +   '<span class="mq-numerator" style="text-align: left; font-size:small; margin-left: 5px; margin-bottom: -3px;">&0</span>'
    +   '<span class="mq-numerator" style="text-align: left; font-size:x-large; margin-bottom: 0px;">&#8721</span>'
    +   '<span class="mq-numerator" style=" text-align: left; font-size:small; margin-left: 5px; margin-top: -3px;">&1</span>'
    + '</span>'
  ;
  _.textTemplate = ['(', ')/(', ')'];
  _.finalizeTree = function() {
...
var CustomMade =
LatexCmds.SigmaTopDownSubScript =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\SigmaTopDownSubScript';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf">'
    +   '<span class="mq-numerator" style="text-align: left; font-size:small; margin-left: 15px; margin-bottom: -5px;">&0</span>'
    +   '<span class="mq-numerator" style="text-align: left; font-size:x-large; margin-bottom: 0px;">&#8721</span>'
    +   '<span class="mq-numerator" style=" text-align: left; font-size:small; margin-left: 15px; margin-top: -5px;">&1</span>'
    + '</span>'
  ;
  _.textTemplate = ['(', ')/(', ')'];
  _.finalizeTree = function() {
...
var CustomMade =
LatexCmds.SigmaDownSubScript =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\SigmaDownSubScript';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf" >'
    
   +   '<span class="mq-numerator" style="text-align: left; font-size:x-large; margin-bottom: 0px;">&#8721</span>'
    +   '<span class="mq-numerator" style=" text-align: left; font-size:small; margin-left: 15px; margin-top: -5px;">&0</span>'
    + '</span>'
  ;
  _.textTemplate = ['/(', ')'];
  _.finalizeTree = function() {
...
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\piUnder';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf" contanteditable="true">'
    
    +   '<span class="mq-numerator" style="text-align: left; font-size:x-large; margin-bottom: 0px;">&#928</span>'
    +   '<span class="mq-numerator" style=" text-align: left; font-size:small; margin-left: 5px; margin-top: -5px;">&0</span>'
    + '</span>'
  ;
  _.textTemplate = ['/(', ')'];
...
var CustomMade =
LatexCmds.PieDownSubScript =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\PieDownSubScript';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf">'
...
var CustomMade =
LatexCmds.piUnderOver =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\piUnderOver';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf" style="margin-top:-7px">'
    +   '<span class="mq-numerator" style="text-align: left; font-size:small; margin-left: 5px; margin-bottom: -5px;">&0</span>'
   +   '<span class="mq-numerator" style="text-align: left; font-size:x-large; margin-bottom: 0px;">&#928</span>'
    +   '<span class="mq-numerator" style=" text-align: left; font-size:small; margin-left: 5px; margin-top: -5px;">&1</span>'
    + '</span>'
  ;
  _.textTemplate = ['(', ')/(', ')'];
  _.finalizeTree = function() {
...
var CustomMade =
LatexCmds.PieTopDownSubScript =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\PieTopDownSubScript';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf">'
    +   '<span class="mq-numerator" style="text-align: left; font-size:small; margin-left: 15px; margin-bottom: -5px;">&0</span>'
   +   '<span class="mq-numerator" style="text-align: left; font-size:x-large; margin-bottom: 0px;">&#928</span>'
...
var CustomMade =
LatexCmds.MatrixOpen =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\MatrixOpen';
  _.htmlTemplate =
    '<span class="mq-fraction mq-non-leaf">'
    +   '<span class="mq-numerator" style=" font-size:small; float:left;">&0</span>'
    +   '<span class="mq-numerator" style=" font-size:small; float:right;">&1</span><br />'
    +   '<span class="mq-numerator" style="  font-size:small; float:left;">&2</span>'
    +   '<span class="mq-numerator" style=" font-size:small; float:right;">&3</span>'
    + '</span>'
  ;
  _.textTemplate = ['(', ')/(', ')/(', ')/(', ')'];
  _.finalizeTree = function() {
...
var CustomMade =
LatexCmds.MatrixEnclose =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\MatrixEnclose';
  _.htmlTemplate =
      '<span class="mq-fraction mq-non-leaf" style="border-left:2px solid black; border-right:2px solid black;">'
    +   '<span class="mq-numerator" style=" font-size:small; float:left;">&0</span>'
    +   '<span class="mq-numerator" style=" font-size:small; float:right;">&1</span><br />'
    +   '<span class="mq-numerator" style="  font-size:small; float:left;">&2</span>'
    +   '<span class="mq-numerator" style=" font-size:small;float:right;">&3</span>'
...
var CustomMade =
LatexCmds.MatrixBracket =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\MatrixBracket';
  _.htmlTemplate =
     '<span class="mq-numerator" style=" font-size:xx-large; float:left; margin-top:10px; margin-left:-25px;  margin-right:-5px;">&#65339</span>'

    +  '<span class="mq-fraction mq-non-leaf" style="margin-top:-10px">'
    +   '<span class="mq-numerator" style=" font-size:small; float:left; margin-right:5px;">&0</span>'
    +   '<span class="mq-numerator" style=" font-size:small; float:right;">&1</span><br />'
    +   '<span class="mq-numerator" style="  font-size:small; float:left; margin-right:5px;">&2</span>'
    +   '<span class="mq-numerator" style=" font-size:small;float:right;">&3</span>'
    + '</span>'

    + '<span class="mq-numerator" style=" font-size:xx-large; float:right; margin-top:10px;  margin-right:-25px; margin-left:-5px;">&#65341</span>'
  ;
  _.textTemplate = ['(', ')/(', ')/(', ')/(', ')'];
  _.finalizeTree = function() {
    this.upInto = this.ends[R].upOutOf = this.ends[L];
...
var CustomMade =
LatexCmds.MatrixPranthesis =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\MatrixPranthesis';
  _.htmlTemplate =
      '<span class="mq-numerator" style=" font-size:xx-large; float:left; margin-top:10px; margin-left:-25px;  margin-right:-5px;">&#65288</span>'
    ...
    + '<span class="mq-numerator" style=" font-size:xx-large; float:right; margin-top:10px;  margin-right:-25px; margin-left:-5px;">&#65289</span>'
  ;
  _.textTemplate = ['(', ')/(', ')/(', ')/(', ')'];
  _.finalizeTree = function() {
    this.upInto = this.ends[R].upOutOf = this.ends[L];
...
var CustomMade =
LatexCmds.threeXoneOpen =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\threeXoneOpen';
  _.htmlTemplate =
    '<span class="mq-fraction mq-non-leaf">'
    +   '<span class="mq-numerator" style=" font-size:; float:left;  text-align:center;">&0</span><br />'
    +   '<span class="mq-numerator" style=" font-size:; float:left;  text-align:center;">&1</span><br />'
    +   '<span class="mq-numerator" style="  font-size:; float:left;  text-align:center;">&2</span>'
    + '</span>'
  ;
  _.textTemplate = ['(', ')/(', ')/(', ')'];
  _.finalizeTree = function() {
...
var CustomMade =
LatexCmds.oneXthreeOpen =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\oneXthreeOpen';
  _.htmlTemplate =
    '<span class="mq-fraction mq-non-leaf">'
    +   '<span class="mq-numerator" style=" font-size:; float:left; margin-left:5px;">&0</span>'
    +   '<span class="mq-numerator" style=" font-size:; float:left; margin-left:5px;">&1</span>'
    +   '<span class="mq-numerator" style="  font-size:; float:left; margin-left:5px;">&2</span>'
    + '</span>'
  ;
  _.textTemplate = ['(', ')/(', ')/(', ')'];
  _.finalizeTree = function() {
...
var CustomMade =
LatexCmds.oneXtwoParenthesis =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\oneXtwoParenthesis';
  _.htmlTemplate =
      '<span class="mq-numerator" style=" font-size:; float:left; margin-top:5px; margin-left:-5px;  margin-right:-5px;">&#65288</span>'

    +  '<span class="mq-fraction mq-non-leaf" style="margin-top:-10px">'
    +   '<span class="mq-numerator" style=" font-size:; float:left; margin-right:5px;">&0</span>'
    +   '<span class="mq-numerator" style=" font-size:; float:right;">&1</span>'
    + '</span>'

    + '<span class="mq-numerator" style=" font-size:; float:right; margin-top:5px;  margin-right:-10px; margin-left:-5px;">&#65289</span>'
  ;
  _.textTemplate = ['(', ')/(', ')'];
  _.finalizeTree = function() {
    this.upInto = this.ends[R].upOutOf = this.ends[L];
...
var CustomMade =
LatexCmds.oneXtwoBracket =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\oneXtwoBracket';
  _.htmlTemplate =
      '<span class="mq-numerator" style=" font-size:; float:left; margin-top:5px; margin-left:-5px;  margin-right:-5px;">&#65339</span>'
    ...
    + '<span class="mq-numerator" style=" font-size:; float:right; margin-top:5px;  margin-right:-10px; margin-left:-5px;">&#65341</span>'
  ;
  _.textTemplate = ['(', ')/(', ')'];
  _.finalizeTree = function() {
    this.upInto = this.ends[R].upOutOf = this.ends[L];
...
var CustomMade =
LatexCmds.twoXoneBracket =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\twoXoneBracket';
  _.htmlTemplate =
      '<span class="mq-numerator" style=" font-size:xx-large; float:left; margin-top:13px; margin-left:-18px;  margin-right:-5px;">&#65339</span>'

    +  '<span class="mq-fraction mq-non-leaf" style="margin-top:-20px">'
    +   '<span class="mq-numerator" style=" font-size:; float:left; margin-bottom:3px; ">&0</span><br />'
    +   '<span class="mq-numerator" style=" font-size:; float:right;  text-align:center; ">&1</span>'
    + '</span>'

    + '<span class="mq-numerator" style=" font-size:xx-large; float:right; margin-top:13px;  margin-right:-25px; margin-left:-5px;">&#65341</span>'
  ;
  _.textTemplate = ['(', ')/(', ')'];
  _.finalizeTree = function() {
    this.upInto = this.ends[R].upOutOf = this.ends[L];
...
var CustomMade =
LatexCmds.twoXoneParenthesis =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\twoXoneParenthesis';
  _.htmlTemplate =
      '<span class="mq-numerator" style=" font-size:xx-large; float:left; margin-top:12px; margin-left:-20px;  margin-right:-5px;">&#65288</span>'

    +  '<span class="mq-fraction mq-non-leaf" style="margin-top:-15px">'
    +   '<span class="mq-numerator" style=" font-size:; float:left; margin-bottom:3px;  text-align:center;">&0</span><br />'
    +   '<span class="mq-numerator" style=" font-size:; float:right;  text-align:center;">&1</span>'
    + '</span>'

    + '<span class="mq-numerator" style=" font-size:xx-large; float:right; margin-top:12px;  margin-right:-25px; margin-left:-5px;">&#65289</span>'
  ;
  _.textTemplate = ['(', ')/(', ')'];
  _.finalizeTree = function() {
    this.upInto = this.ends[R].upOutOf = this.ends[L];
...
var CustomMade =
LatexCmds.threeXthreeBracket =
LatexCmds.Custom = P(MathCommand, function(_, super_) {
  _.ctrlSeq = '\\threeXthreeBracket';
  _.htmlTemplate =
      

      '<span class="mq-fraction mq-non-leaf" style="margin-top:0px">'
    +  '<span class="mq-numerator" style=" font-size:40px; float:left; display: block;  margin-top:25px; margin-left:-15px;  margin-right:0px;">&#65339</span>'  
    +   '<span class="mq-numerator" style=" font-size:; float:left; margin-bottom:1px; margin-right:1px;">&0</span>'
    +   '<span class="mq-numerator" style=" font-size:; float:;margin-bottom:1px; margin-right:1px;">&1</span>'
    +   '<span class="mq-numerator" style=" font-size:; float:right;margin-bottom:1px; margin-right:1px;">&2</span><br />'
    +   '<span class="mq-numerator" style=" font-size:; float:left; margin-bottom:1px; margin-right:1px;">&3</span>'
    +   '<span class="mq-numerator" style=" font-size:; float:;margin-bottom:1px; margin-right:1px;">&4</span>'
    +   '<span class="mq-numerator" style=" font-size:; float:right;margin-bottom:1px; margin-right:1px;">&5</span><br />'
    +   '<span class="mq-numerator" style=" font-size:; float:; margin-bottom:1px; margin-right:1px;">&6</span>'
    +   '<span class="mq-numerator" style=" font-size:; float:left;margin-bottom:1px; margin-right:1px;">&7</span>'
    +   '<span class="mq-numerator" style=" font-size:; float:right;margin-bottom:1px; margin-right:1px;">&8</span><br />'
    + '<span class="mq-numerator" style=" font-size:40px; float:right; transform: scale(.5, 1.5); margin-top: -35px;  margin-right:-15px; margin-left:0px;">&#65341</span>'
    + '</span>'
