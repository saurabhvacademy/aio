...
@Component({
    selector: 'app-multiplechoicepost',
    templateUrl: './multiplechoicepost.component.html',
    // host: { "(document:click)": "handleClick($event)" },
    providers: [PostdataService],
    styleUrls: ['./multiplechoicepost.component.scss', './../textpost/allpost.css']
})
export class MultiplechoicepostComponent implements OnInit {
    ...
    hideSocialList() {
        let id = this.u_id + '_' + this.post_id + '_mcShareList';
    ...
    ngOnInit() {
        ...
        //        for (var i = 0; i < this.arr['ANSWER'].lengt        h;i++){
        //            this.correctAnswer = this.arr['ANSWE        R'][i];
        //                     =
        //
        //        }
        ...
        this.myResponseStatus = this.arr['RESPONSE_STATUS'];
this.setInterestObj();
            ...
            if (this.responseStatus == 1 && this.questionTime != 0 && this.resultDeclared == false) {
                for (var i = 0; i < this.myResponse.length; i++) {
                    if (this.myResponse[i] == "A") {
                        var a = (<HTMLInputElement>document.getElementById(this.post_id + "_option1"));
                        if (a != null) {
                            a.checked = true;
                        }
                    }
                    if (this.myResponse[i] == "B") {
                        var b = (<HTMLInputElement>document.getElementById(this.post_id + "_option2"));
                        if (b != null) {
                            b.checked = true;
                        }
                    }
                    if (this.myResponse[i] == "C") {
                        var c = (<HTMLInputElement>document.getElementById(this.post_id + "_option3"));
                        if (c != null) {
                            c.checked = true;
                        }
                    }
                    if (this.myResponse[i] == "D") {
                        var d = (<HTMLInputElement>document.getElementById(this.post_id + "_option4"));
                        if (d != null) {
                            d.checked = true;
                        }
                    }
                    if (this.myResponse[i] == "E") {
                        var e = (<HTMLInputElement>document.getElementById(this.post_id + "_option5"));
                        if (e != null) {
                            e.checked = true;
                        }
                    }
                    if (this.myResponse[i] == "F") {
                        var f = (<HTMLInputElement>document.getElementById(this.post_id + "_option6"));
                        if (f != null) {
                            f.checked = true;
                        }
                    }
                ...
                //                if ((<HTMLButtonElement> document.getElementById(this.post_id + "_submit")) != null) {
    ...
    changeView() {
        ...
        //        if (this.option1 != "") {
        //            document.getElementById(this.post_id + "_option1").innerHTML = this.option1;
        //            this.postdata.getOption1TextToSave(this.post_id);
        //        }
        //        if (this.option2 != "") {
        //            document.getElementById(this.post_id + "_option2").innerHTML = this.option2;
        //            this.postdata.getOption2TextToSave(this.post_id);
        //        }
        //        if (this.option3 != "") {
        //            document.getElementById(this.post_id + "_option3").innerHTML = this.option3;
        //            this.postdata.getOption3TextToSave(this.post_id);
        //        }
        //        if (this.option4 != "") {
        //            document.getElementById(this.post_id + "_option4").innerHTML = this.option4;
        //            this.postdata.getOption4TextToSave(this.post_id);
        //        }
        //        if (this.option5 != "") {
        //            document.getElementById(this.post_id + "_option5").innerHTML = this.option5;
        //            this.postdata.getOption5TextToSave(this.post_id);
        //        }
        //        if (this.option6 != "") {
        //            document.getElementById(this.post_id + "_option6").innerHTML = this.option6;
        //            this.postdata.getOption6TextToSave(this.post_id);
        //        }
    }
    ...
    DeletePostCnf() {
        ...
        this.dataConf['pid'] = this.arr['USER_POST_ID'];
