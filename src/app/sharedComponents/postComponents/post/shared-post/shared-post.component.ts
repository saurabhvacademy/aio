...
@Component({
    selector: 'app-sharedpost',
    templateUrl: './shared-post.component.html',
    // host: { "(document:click)": "handleClick($event)" },
    providers: [PostdataService],
    styleUrls: ['../postcommon.css', '../allpostcommon.css', './shared-post.component.scss' ]
})


export class SharedPostComponent implements OnInit, AfterViewInit {
    ...
    // sharescreentxtsec: boolean = false;
    ...
    ngOnInit() {
        this.arr.SHARED_POST_DATA.INTERESTS=JSON.parse(this.arr.SHARED_POST_DATA.INTEREST).Interest;
    ...
    setHeaderData(){
        var headerData = {
            ...
            profile_pic_path:"assets/images/svg-three/post_icon/share.svg",
            pg_id:this.pg_id,
            ...
            sharedPostUser_fullName:this.sharedPostUser_fullName
