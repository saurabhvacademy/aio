...
import { Component, ViewChild, OnInit, ComponentFactoryResolver, ViewContainerRef, Input, AfterViewInit, HostListener } from '@angular/core';
...
@Component({
    selector: 'app-sharedvideopost',
    templateUrl: './sharedvideopost.component.html',
    styleUrls: ['./sharedvideopost.component.scss', './../sharetextpostview/sharetextpostview.component.scss', './../textpost/allpost.css']
})
export class SharedvideopostComponent implements OnInit {
    oldValue: boolean;
    ...
    hideSocialList() {
        let id = this.u_id + '_' + this.post_id + '_shareVShareList';
    ...
    ngOnInit() {
        ...
        this.sharededitPostId = this.shared_u_id + ":" + this.sharedPostId + ":" + this.arr['SHARED_POST_DATA']['TYPE'];
        ...
        if (this.arr['SHARED_POST_DATA']['TYPE'] == 5) {
            ...
            this.activeVideoSrc = "https://www.youtube.com/embed/" + this.arr['SHARED_POST_DATA']['SHARE_LINK'];
            ...
            this.activeVideoSrc = "https://player.vimeo.com/video/" + this.arr['SHARED_POST_DATA']['SHARE_LINK'];
        }
