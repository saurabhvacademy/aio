import { Component, ViewChild, OnInit, Output, EventEmitter, ComponentFactoryResolver, ViewContainerRef, AfterViewInit, ElementRef, HostListener } from '@angular/core';
...
@Component({
    ...
    styleUrls: ['./textpost-component.scss', './allpost.css']
})
export class TextpostComponent implements OnInit, AfterViewInit {
    postPublicShareLink = '';
