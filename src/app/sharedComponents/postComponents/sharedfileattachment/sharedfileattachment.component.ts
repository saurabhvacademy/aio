...
@Component({
    selector: 'app-sharedfileattachment',
    templateUrl: './sharedfileattachment.component.html',
    // host: { "(document:click)": "handleClick($event)" },
    styleUrls: ['./sharedfileattachment.component.scss', './../sharetextpostview/sharetextpostview.component.scss', './../textpost/allpost.css']
})
export class SharedfileattachmentComponent implements OnInit {
    ...
    pg_uuid = "";
    title = '';
    likedetailspopup: boolean = false;
    ...
    showSharePostList(event) {
        let id = this.u_id + '_' + this.post_id + '_shareFileShareList';
    ...
    ngOnInit() {
        ...
        this.share = parseInt(this.arr['SHARED_POST_DATA']['SHARED_COUNT']);
    ...
    downloadCount() {
        ...
        downloadCount['pid'] = this.sharedPostId;
