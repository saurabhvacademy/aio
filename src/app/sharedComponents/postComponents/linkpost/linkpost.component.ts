...
@Component({
    selector: 'app-linkpost',
    // host: {
    //     '(document:click)': 'handleClick($event)',
    // },
    templateUrl: './linkpost.component.html',
    providers: [PostdataService],
    styleUrls: ['./../textpost/allpost.css', './linkpost.component.scss']
})
export class LinkpostComponent implements OnInit, AfterViewInit {
    ...
    hideSocialList() {
        let id = this.u_id + '_' + this.post_id + '_linkShareList';
    ...
    ngOnInit() {
        ...
        // }
        console.log("link post", this.arr);
...
this.setInterestObj();
        ...
        if (this.arr['SHARE_LINK_TITLE'] != null && this.arr['SHARE_LINK_TITLE'] != "")
            this.link_title = this.post.decodeURIPostData(this.arr['SHARE_LINK_TITLE']);
        if (this.arr['SHARE_LINK_DESCRIPTION'] != null && this.arr['SHARE_LINK_DESCRIPTION'] != "")
            this.link_description = this.post.decodeURIPostData(this.arr['SHARE_LINK_DESCRIPTION']);
        if (this.arr['SHARE_LINK_IMAGE']) {
            if (this.arr['SHARE_LINK_IMAGE'] == "https://study247.s3-accelerate.amazonaws.com/logo_200x200.png" && this.arr['LINK_PTYPE'] == 0) {
                this.image_path = "";
            } else {
        ...
        // this.displayText = this.post.getTextFromHyperlink(this.post_data);
        ...
        if (this.arr['PAGE_UUID'] != '' && this.arr['PAGE_UUID'] != null) {
            ...
            this.user_name = this.post.decodeURIPostData(this.arr['TITLE']);
        } else {
