...
@Component({
  selector: 'app-sharelinkedin',
  templateUrl: './sharelinkedin.component.html',
  styleUrls: ['./sharelinkedin.component.scss']
})
export class SharelinkedinComponent implements AfterViewInit {
